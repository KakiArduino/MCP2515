...
print("Pr. Fabrico Ferrari - PPGFIS IMEF FURG")
print("Pr. Edson M. Kakuno - Fisica Unipampa Bage")
...
arq.write("Pr. Fabrico Ferrari - PPGFIS IMEF FURG\n")
arq.write("Pr. Edson M. Kakuno - Fisica Unipampa Bage\n\n")
